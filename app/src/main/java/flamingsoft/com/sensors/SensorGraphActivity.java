...
package flamingsoft.com.sensors;
...
public class SensorGraphActivity extends Activity implements View.OnTouchListener {
	...
	public static final String SENSORINDEX = "com.uday.stools.SensorIndex";
...
public ImageView recordImg;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		sensorManager = (SensorManager) getSystemService(SENSOR_SERVICE);
			...
			sensor = sensorManager.getSensorList(Sensor.TYPE_ALL).get(0);
			...
			renderer.setXAxisMax(5000 / (1000 / SAMPLERATE)); // 10 seconds wide
...
//			{
//
//				recordImg.setImageDrawable(getResources().getDrawable(R.drawable.stop));
//			}
//		});
...
return true;
	...
	protected void onResume() {
		...
		if (xTick == 0) {
			...
			boolean sensorAvilable =  sensorManager.registerListener((SensorEventListener) ticker, sensor,
					SensorManager.SENSOR_DELAY_UI);
			...
			if(!sensorAvilable)
			{
				if (sensor == null)
				{
					...
					textView.setText(sensor.getName() + " sensor is not available");
				}
			}
